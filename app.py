                                ...
                                "items": {
                                    ...
                                    "ارجاع": {
                                        ...
                                        "properties": {
                                            "شماره_بند": {
                                            "type": "string",
                                            "description": "شماره بند مربوطه در گزارش حسابرس .بین بند ها , قرار بده مانند ۲,۶"
                                        },
                                        "شماره_صفحه": {
                                            "type": "string",
                                            "description": "شماره صفحه مربوطه در گزارش حسابرس.چنانچه این مورد در چند بند به ان اشاره شده صفحات منطبق با بند را به ترتیب بند برگردان بین صفحات , قرار بده مانند ۱,۵"
                                        }
                                        },
                                        "required": [
                                        "شماره_بند",
                                ...
                                "items": {
                                    ...
                                    "ارجاع": {
                                        ...
                                        "properties": {
                                            "شماره_بند": {
                                            "type": "string",
                                            "description": "شماره بند مربوطه در گزارش بازرس قانونی .بین بند ها , قرار بده مانند ۲,۶"
                                        },
                                        "شماره_صفحه": {
                                            "type": "string",
                                            "description": "شماره صفحه مربوطه در گزارش بازرس قانونی.چنانچه این مورد در چند بند به ان اشاره شده صفحات منطبق با بند را به ترتیب بند برگردان بین صفحات , قرار بده مانند ۱,۵"
                                        }
                                        },
                                        "required": [
                                        "شماره_بند",
